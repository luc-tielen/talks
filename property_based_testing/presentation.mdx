...
- TODO picture of test output + how to run in mocha
...
- TODO example in JS using verify (commutative addition)
...
- "Directed" randomness: e.g. -1, 0, 1, NaN, weird unicode chars, undefined, ...
...
- TODO example, check if examples can be made in REPL
