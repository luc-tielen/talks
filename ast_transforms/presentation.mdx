...
<Steps>
  <SVG contents={require("./schematics/compiler_structure.dot")}
        width="75vw"/>
  <SVG contents={require("./schematics/compiler_structure2.dot")}
        width="75vw"/>
</Steps>
...
<SVG contents={require("./schematics/simple_ast.dot")}
     width="25vw"/>
...
<Split>
  <SVG contents={require("./schematics/ast_transform1.dot")}
       width="25vw"/>
  <SVG contents={require("./schematics/ast_transform2.dot")}
       width="25vw"/>
</Split>
...
<SVG contents={require("./schematics/normal_compiler.dot")}
     width="10vw"/>
...
<SVG contents={require("./schematics/micropass_compiler.dot")}
     width="75vw"/>
...
<SVG contents={require("./schematics/nanopass_compiler.dot")}
     width="75vw"/>
